	...
	switch (Opcion) {
      ...
      fURL=URL ;
			...
			if (Opcion=="importarHTML")
				...
				Mfn=mfn;
			msgwin=window.open("","Upload","status=yes,resizable=yes,toolbar=no,menu=no,scrollbars=yes,width=800,height=200,top=100,left=5");
			...
			msgwin.document.writeln("<input type=hidden name=base value="+base+">");
			msgwin.document.writeln("<input type=hidden name=Tag value="+Tag+">");
			msgwin.document.writeln("<input type=hidden name=fURL value="+fURL+">");
			msgwin.document.writeln("<input type=hidden name=Tipo value="+Tipo+">");
//			msgwin.document.writeln("<input type=hidden name=Ffi value="+FFI+">");

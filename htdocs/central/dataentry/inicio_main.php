...
function TipoDeRegistro(){
	...
	for (i=0;i<ix;i++){
		if (Trim(tr[i])!=""){
			linea=tr[i].split('|')
			top.main.document.writeln("<tr><td><a href=\"javascript:top.wks='"+tr[i]+"|"+tl+"|"+nr+"';top.Menu('crear')\"><span style='font-size:10px;'>"+linea[3]+"</span></a></td>")
		}
	}
...
?>    
    	<frame name="menu"  src="" scrolling="no" frameborder="0"  marginheight="0"   MARGINWIDTH="5">
	<frame name="main"  src="" scrolling="yes" frameborder="0"  marginheight="0"   MARGINWIDTH="0">

...
<?php if (isset($_SESSION["permiso"]["CENTRAL_IMPEXP"]) or isset($_SESSION["permiso"]["CENTRAL_DBUTILS"]) or isset($_SESSION["permiso"]["CENTRAL_ALL"])	      or isset($_SESSION["permiso"][$db."_CENTRAL_IMPEXP"]) or isset($_SESSION["permiso"][$db."_CENTRAL_DBUTILS"]) or isset($_SESSION["permiso"][$db."_CENTRAL_ALL"])){?>
...
if (isset($_SESSION["permiso"]["CENTRAL_GLOBALC"]) or isset($_SESSION["permiso"]["CENTRAL_DBUTILS"]) or isset($_SESSION["permiso"]["CENTRAL_ALL"])
    or isset($_SESSION["permiso"][$db."_CENTRAL_GLOBALC"]) or isset($_SESSION["permiso"][$db."_CENTRAL_DBUTILS"]) or isset($_SESSION["permiso"][$db."_CENTRAL_ALL"])){					echo "

 ...
 * @author:    Guilda Ascencio, Marino Borrero Sánchez
 * @since:     20091203
 * @version:   1.0
 *
 * == BEGIN LICENSE ==
...
$mx920=$pathMX.$ver." ".$pathDB."/".$base."/data/".$base." from=".$fromto." to=".$fromto." pft=v$tag";
...
session_start();//esto es temporal
$rpctag=$_SESSION['rpctag'];
$mx920=$mx_path.$cisis_ver." ".$db_path."/".$arrHttp['base']."/data/".$arrHttp['base']." from=".$arrHttp['Mfn']." to=".$arrHttp['Mfn']." pft=v$rpctag"; 
...
$rpctag=$_SESSION['rpctag'];
	$passHttp=$_POST['pass'];
	$actreguser=RPC($mx_path,$cisis_ver,$db_path,$arrHttp['base'],$arrHttp['Mfn'],$rpctag,$passHttp);
	//end check RPC	
		if($actreguser)
{
		include ("scripts_dataentry.php");

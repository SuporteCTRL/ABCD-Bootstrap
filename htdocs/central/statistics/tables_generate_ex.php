...
<a href="../documentacion/ayuda.php?help=<?php echo $_SESSION['lang']?>/stats/stats_tables_generate.html#TABLE" target="_blank">
			<span class="glyphicon glyphicon-question-sign"></span><?php echo $msgstr["help"]?></a>
<?php
if (isset($_SESSION["permiso"]["CENTRAL_EDHLPSYS"]))
?>
	<a href="../documentacion/edit.php?archivo=<?php echo $_SESSION['lang']; ?>/stats/stats_tables_generate.html#TABLE" target=_blank>			
...
<?php echo $msgstr["sendto"]; ?>
	<a class="btn btn-primary" href="javascript:SendTo('W')"><i class="fa fa-file-excel-o"></i>&nbsp;<?php echo $msgstr["wks"]; ?></a> &nbsp;  &nbsp;
	<a class="btn btn-primary" href="javascript:SendTo('D')"><i class="fa fa-file-word-o"></i>&nbsp;<?php echo $msgstr["doc"]; ?></a> &nbsp;  &nbsp;
	<a class="btn btn-primary" href="javascript:SendTo('P')"><i class="fa fa-print"></i>&nbsp;<?php echo $msgstr["prn"]; ?></a> &nbsp;  &nbsp;
	<a class="btn btn-primary" href="javascript:SendTo('AG')"><i class="fa fa-bar-chart-o"></i>&nbsp;<?php echo $msgstr["ag"]; ?></a> &nbsp;  &nbsp;
...
if (isset($arrHttp["tables"]) or isset($arrHttp["cols"]) and isset($arrHttp["rows"]) ){
	...
	$ix=count($col);
	echo "<table class=table cellpadding=5>";
	echo "<tr><th>&nbsp;</th><th colspan=$ix $tcol_tit</th><th>&nbsp;</th>";
	...
	foreach ($row as $x){
		if (trim($x)=="")
			...
			echo "<tr><td bgcolor=#f4f4f4>$x</td>";
		$total_r=0;
	...
	echo "<tr><td bgcolor=#ccc><strong>".$msgstr["total"]."</strong></td>";
	$total=0;
